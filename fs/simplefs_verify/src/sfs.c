...
static struct fuse_operations operations = {
	...
	.write = NULL, // sfs_write,								  /* 写入文件 */
	.read = NULL, // sfs_read,								  /* 读文件 */
	.utimens = sfs_utimens,							  /* 修改时间，忽略，避免touch报错 */
	.truncate = NULL, // sfs_truncate,						  /* 改变文件大小 */
	.unlink = NULL, // sfs_unlink,							  /* 删除文件 */
	.rmdir	= NULL, //sfs_rmdir,							  /* 删除目录， rm -r */
	.rename = NULL, //sfs_rename,							  /* 重命名，mv */
